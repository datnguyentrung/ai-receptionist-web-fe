...
export default function LeftPanel() {
  return (
    <div className={styles.leftPanel}>
      {/* Decorative SVG — desktop only, hidden via CSS on mobile */}
      ...
      <div className={styles.leftPanelContent}>
        ...
        <div className={styles.brandName}>
          <span className={styles.brandNameMain}>Taekwondo</span>
          <span className={styles.brandNameAccent}>VAN QUÁN</span>
        </div>

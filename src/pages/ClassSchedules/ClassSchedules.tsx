...
export function ClassSchedules() {
  ...
  if (logic.sessionsError) {
    toast.error("L?i khi t?i các bu?i h?c s?p di?n ra");
  }
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        loadingText="Ðang c?p nh?t..."
        isLoading={logic.isChangingStatus}
        onCancel={logic.closeChangeStatusModal}
        onConfirm={logic.confirmStatusChange}
        successToastMessage="C?p nh?t tr?ng thái l?p h?c thành công"
        errorToastMessage="Không th? c?p nh?t tr?ng thái l?p h?c"
      />
